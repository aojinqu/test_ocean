...
private:
	Math::AABox					boundingbox;		//边界框..?
	OpenGLAttributeRange*		subsettable;
	OpenGLMaterial*				materials;			//材质
...
public:
	OpenGLScreenQuad(const char* psfile = "shaders/ocean/screenquad.frag", const char* defines = nullptr);
	~OpenGLScreenQuad();
