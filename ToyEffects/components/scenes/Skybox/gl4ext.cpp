...
#include <ToyEffects/scenes/Skybox/geometryutils.h>
#include <ToyEffects/scenes/Skybox/dds.h>
//#include "gl4ext.h"
...
GLuint OpenGLEffect::GetProgramId()
{
	return program;
}
...
OpenGLScreenQuad::OpenGLScreenQuad(const char* psfile, const char* defines)
{
	...
	if (psfile != nullptr) {
		GLCreateEffectFromFile("shaders/ocean/screenquad.vert", 0, 0, 0, psfile, &effect, defines);
